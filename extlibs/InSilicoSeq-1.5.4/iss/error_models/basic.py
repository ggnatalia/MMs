...
class BasicErrorModel(ErrorModel):
    ...
    ######### NEW
    def __init__(self, read_length = 125, insert_size = 200):
        super().__init__()
        self.read_length = read_length
        self.insert_size = insert_size
        self.quality_forward = self.quality_reverse = 30

        print('read_length: ' + str(self.read_length))
        print('insert_size: ' + str(self.insert_size))
        print('quality_forward: ' + str(self.quality_forward))
        print('quality_reverse: ' + str(self.quality_reverse))
    #def __init__(self):
        #super().__init__()
