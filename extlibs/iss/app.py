...
def main():
    ...
    parser_gen.add_argument(
        ...
        nargs = '+',
        type = int,
        help = '(Read length, insert size) \
        CHANGED BY ggnatalia IN ~/.local/lib/python3.6/site-packages/iss/error_models/perfect.py \
        ONLY works for basic and perfect modes. '
    )
    ################## END
    parser_gen.add_argument(
        '--model',
