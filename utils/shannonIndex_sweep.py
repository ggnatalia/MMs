...
def main(args): 
    ...
    #command = ['mothur', '#pcr.seqs(fasta = {}/{}, start = {}, end = {})'.format(projectPath, args.align, args.start, args.end)]
    #runCommand(command)
    command = ['mothur','#dist.seqs(fasta = {}/{}.align)'.format(projectPath, args.align.replace('.align', ''))]
    runCommand(command)
